#ifndef __UBTC_UNETWORKS_H__
#define __UBTC_UNETWORKS_H__

#include <stdint.h>

/** \brief Prefixes for particular unetwork (Mainnet / Testnet ).<br>
...
extern const Unetwork Mainnet;
extern const Unetwork Testnet;
extern const Unetwork Regtest;
extern const Unetwork Signet;

extern const Unetwork * unetworks[];
extern const uint8_t unetworks_len;

#endif // __UBTC_UNETWORKS_H__